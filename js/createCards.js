export const Cards = {
    ...
    moda: [
        {
            id: 1,
            name: "Conjunto de Jeans",
            descripcion: "Un conjunto versátil de jeans para primavera, ideal para tus días de sol. Con un diseño cómodo y elegante, es perfecto para cualquier ocasión casual.",
            img: "../imgs/productos/ropa/primavera1.jpg",
            alt: "Imagen de conjunto de jeans con camiseta blanca"
        },
        {
            id: 2,
            name: "Falda de jean",
            descripcion: "Una falda de jean clásica, perfecta para combinar con cualquier top. Confeccionada con materiales de alta calidad para un ajuste cómodo y duradero.",
            img: "../imgs/productos/ropa/primavera2.jpg",
            alt: "Imagen de falda de jean de corte recto"
        },
        {
            id: 3,
            name: "Blusa de gasa",
            descripcion: "Esta blusa de gasa es la opción ideal para días cálidos. Su tela ligera y fluida te mantendrá fresca mientras luces un estilo sofisticado y moderno.",
            img: "../imgs/productos/ropa/primavera3.jpg",
            alt: "Imagen de blusa de gasa en color claro"
        },
        {
            id: 4,
            name: "Vestido floreado fibrana",
            descripcion: "Un vestido fresco de fibrana con estampado floral, perfecto para las tardes de verano. Ligero y cómodo, ideal para paseos y reuniones informales.",
            img: "../imgs/productos/ropa/verano1.jpg",
            alt: "Imagen de vestido floreado de fibrana"
        },
        {
            id: 5,
            name: "Blusa floreada de gasa",
            descripcion: "Una blusa de gasa con un delicado estampado floral, perfecta para combinar con jeans o faldas. Su diseño ligero y elegante te permitirá disfrutar de la primavera con estilo.",
            img: "../imgs/productos/ropa/verano2.jpg",
            alt: "Imagen de blusa floreada de gasa con mangas cortas"
        },
        {
            id: 6,
            name: "Conjunto sastrero",
            descripcion: "Este conjunto sastrero es perfecto para ocasiones especiales. Con un corte impecable y un estilo sofisticado, te permitirá destacar en cualquier evento formal.",
            img: "../imgs/productos/ropa/verano3.jpg",
            alt: "Imagen de conjunto sastrero con chaqueta y pantalón"
        }
    ],
    ...
    accesorios: [
        {
            id: 1,
            name: "Cinturón con perlas",
            descripcion: "Un cinturón elegante decorado con perlas que aporta un toque sofisticado a cualquier look. Ideal para eventos formales o cenas especiales.",
            img: "../imgs/productos/Accesorios/accesorio1.jpg",
            alt: "Imagen de cinturón con perlas en primer plano"
        },
        {
            id: 2,
            name: "Lentes estilo rasgado",
            descripcion: "Unos lentes modernos con diseño rasgado, perfectos para protegerte del sol mientras luces un estilo chic y sofisticado.",
            img: "../imgs/productos/Accesorios/accesorio2.jpg",
            alt: "Imagen de lentes rasgados sobre fondo blanco"
        },
        {
            id: 3,
            name: "Zapatos taco especial",
            descripcion: "Zapatos con tacón único, diseñados para combinar comodidad y estilo. Perfectos para ocasiones formales o un look de oficina impecable.",
            img: "../imgs/productos/Accesorios/accesorio3.jpg",
            alt: "Imagen de zapatos de tacón alto y elegante"
        },
        {
            id: 4,
            name: "Bolso negro de cuero",
            descripcion: "Un clásico bolso negro de cuero con acabado elegante. Espacioso y versátil, ideal para el día a día o salidas nocturnas.",
            img: "../imgs/productos/Accesorios/bolso1.jpg",
            alt: "Imagen de bolso negro de cuero sobre superficie lisa"
        },
        {
            id: 5,
            name: "Bolso borgoña charol",
            descripcion: "Un bolso de charol en color borgoña que añade un toque de glamour a tu atuendo. Compacto y con estilo moderno.",
            img: "../imgs/productos/Accesorios/bolso2.jpg",
            alt: "Imagen de bolso charol borgoña en primer plano"
        },
        {
            id: 6,
            name: "Bolso Dior",
            descripcion: "Un bolso Dior, elegante y sofisticado. Perfecto para elevar cualquier outfit a un nivel de lujo.",
            img: "../imgs/productos/Accesorios/bolso3.jpg",
            alt: "Imagen de bolso Dior de lujo sobre mesa"
        }
    ],
    hogar: [
        {
